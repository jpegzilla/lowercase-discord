...
(b=a.content.replace(prefix,"").trim())&&handleUserCommands(b,a)});var express=require("express"),app=express(),port=process.env.PORT||3E3;app.listen(port,function(){console.log("listening on port",port)});
