...
var discord=require("discord.js"),$jscomp$destructuring$var0=require("./config.json"),prefix=$jscomp$destructuring$var0.prefix,handleUserCommands=require("./commands"),client=new discord.Client,https=require("https"),correction=!0;module.exports=correction;client.once("ready",function(){console.log("ready.");setInterval(function(){return https.get("https://lowercase-discord.herokuapp.com/")},3E5)});
