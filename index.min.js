...
b&&handleUserCommands(b,a)):c.test(a.content)?(b=d(b,e).said,a.channel.send(""+b),a["delete"]()):a.content.startsWith(prefix)&&(b=a.content.replace(prefix,"").trim())&&handleUserCommands(b,a)});client.login(token);
